...
import (
	"fmt"
	"github.com/Benbentwo/ui-survey/pkg/github"
...
func (o *VersionOptions) InstallBin(upgrade bool, prefix string, version string) error {
	...
	// BinaryDownloadBaseURL := "https://github.com/Benbentwo/ui-survey/releases/download/v1.0.0/
	// 							 https://github.com/Benbentwo/ui-survey/releases/download/v1.0.0/ui-survey-windows-amd64.zip"
